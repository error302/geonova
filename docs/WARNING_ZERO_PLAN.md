...
| **total** | **261** | CI ceiling **500** | green |
...
| `no-unused-vars` | **261** | `_`-prefix unused bindings, drop dead imports/state/props | batches 1–10 drained 879 sites (batch 10 = the whole 2-warning tier: 120 files / 240 sites — API routes, pages, components, libs/hooks/tests); next: batch 11 — 1-warning tail (261 files) |
...
3. Tighten `--max-warnings`: 20,000 → 10,000 → 5,000 → 3,700 → 3,000 → 2,800 → 2,000 → 1,500 → 1,400 → 1,350 → 1,100 → 1,000 → 700 → 550 → **500** (now) → **0** as the totals shrink (total is 261). Keep the ceiling documented in the workflow files.
