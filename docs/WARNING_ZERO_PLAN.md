...
| **total warnings** | **501** | CI ceiling **550** | green |
...
| **total** | **501** | CI ceiling **550** | green |
...
3. Tighten `--max-warnings`: 20,000 → 10,000 → 5,000 → 3,700 → 3,000 → 2,800 → 2,000 → 1,500 → 1,400 → 1,350 → 1,100 → 1,000 → 700 → **550** (now) → **500** → **0** as the totals shrink (total is 501). Keep the ceiling documented in the workflow files.
