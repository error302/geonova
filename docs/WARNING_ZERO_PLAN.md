...
**Progress:** 14,030 → **928** (measured 2026-08-12, `lint-ratchets --report` on origin/main). Row-typing (0/538), a11y (0 findings), member-access, explicit-any, argument, **assignment**, no-unsafe-return and no-unsafe-call are **done** (rules flipped to `error`); `no-unused-vars` + the mechanical rules remain.
...
**Checklist state (live scan 2026-08-12, origin/main @ `990c7609` — committed total 928):**
...
| **total** | **928** | CI ceiling **1,100** | green |
...
3. Tighten `--max-warnings`: 20,000 → 10,000 → 5,000 → 3,700 → 3,000 → 2,800 → 2,000 → 1,500 → 1,400 → 1,350 → 1,100 (now) → **500** → **0** as the totals shrink (total is 977). Keep the ceiling documented in the workflow files.
