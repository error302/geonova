        ...
        headers: [
          ...
          ...(isProd ? [{ key: 'Strict-Transport-Security', value: 'max-age=63072000; includeSubDomains; preload' }] : []),
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://*.supabase.co https://*.tile.openstreetmap.org https://*.mapbox.com",
              "connect-src 'self' https://*.supabase.co https://ipapi.co wss://*.supabase.co https://*.upstash.io",
