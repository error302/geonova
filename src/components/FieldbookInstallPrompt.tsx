...
export default function FieldbookInstallPrompt() {
  ...
  return (
    <div className="fixed bottom-20 left-3 right-3 z-40 flex items-center gap-3 px-3 py-2.5 rounded-xl bg-[color-mix(in_srgb,var(--bg-secondary)_92%,transparent)] backdrop-blur-xl border border-[var(--accent)]/20 shadow-lg md:hidden">
