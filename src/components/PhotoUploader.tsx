    ...
    <div className="space-y-3">
      ...
      {photos.length > 0 && (
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {photos.map((photo, i) => (
            <div key={`${photo}-${i}`} className="border border-[var(--border-color)] rounded-lg p-3 bg-[color-mix(in_srgb,var(--bg-tertiary)_30%,transparent)]">
              <div className="flex gap-2">
                ...
                <div className="flex-1 min-w-0 space-y-1.5">
                  ...
                  <input
                    ...
                    aria-label="View direction (e.g. Looking North)"
                    className="w-full px-2 py-1 text-xs bg-[var(--bg-tertiary)] border border-[var(--border-color)] rounded text-[var(--text-primary)]"
                  />
                  <button
