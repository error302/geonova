...
import type { WorkingDiagram, BeaconPoint, BoundaryLine, SubArea } from '@/lib/working-diagram/types'
import { metersToLegacy, dmsToDeg } from '@/lib/working-diagram/units'
