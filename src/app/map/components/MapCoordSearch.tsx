    ...
    <div className="absolute top-3 left-[344px] z-20 md:left-[344px]">
      <div className="relative">
        <input
          ...
          className="h-8 bg-[var(--bg-secondary)]  border border-[var(--border-color)]/[0.06] rounded-lg pl-7 pr-3 text-[11px] text-[var(--text-primary)] placeholder-gray-600 focus:outline-none focus:border-[var(--accent)]/30 transition-colors w-[160px] sm:w-[200px] md:w-[280px]"
        />
        <button
