...
export function IdentifyPanel({ feature, onClose, onEdit, onDelete, onZoomTo }: IdentifyPanelProps) {
  ...
  return (
    <div className="absolute top-[280px] right-3 z-30 w-80 max-h-[calc(100%-320px)] bg-[var(--bg-secondary)]  border border-[var(--border-color)]/[0.08] rounded-2xl shadow-2xl overflow-hidden flex flex-col animate-in fade-in slide-in-from-right-2 duration-200">
      {/* Header */}
