...
export function SnappingOptions({
  ...
  return (
    <div className="absolute top-[340px] right-3 z-30 w-72 bg-[var(--bg-secondary)]  border border-[var(--border-color)]/[0.08] rounded-2xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-right-2 duration-200">
      {/* Header */}
