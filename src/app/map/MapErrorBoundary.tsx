...
> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="h-[calc(100vh-4rem)] bg-black/60  flex items-center justify-center">
          <div className="text-center max-w-lg px-6 bg-[var(--bg-secondary)] rounded-xl py-6 shadow-2xl">
            ...
            <button
              ...
              className="mt-4 px-5 py-2 bg-[var(--accent)] hover:bg-[var(--accent)]/80 text-[var(--text-primary)] text-sm rounded-lg transition-colors"
            >
              Reload Page
            </button>
          </div>
