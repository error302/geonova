...
interface ControlPointVerificationRow {
  id: string
  point_type: string
  point_id: string
  ...
  verifier_license: string | null
  measured_easting: number | null
  measured_northing: number | null
  measured_elevation: number | null
  published_easting: number | null
  published_northing: number | null
  published_elevation: number | null
  delta_e: number | null
  delta_n: number | null
  delta_h: number | null
...
export const GET = apiHandler(
  ...
  async (req, _ctx) => {
    ...
    const { rows } = await db.query<ControlPointVerificationRow>(sql, values)
...
export const POST = apiHandler(
  ...
  async (_req, ctx) => {
    ...
    const { rows } = await db.query<ControlPointVerificationRow>(
