...
interface CadastraValidationRow {
  id: string
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const body = rawBody as ValidateRequest
    ...
    logger.error('Cadastra validation error:', { error })
...
export async function GET(request: NextRequest) {
  ...
  try {
    if (validationId) {
      const result = await db.query<CadastraValidationRow>(
    ...
    logger.error('Cadastra validations GET error:', { error })
