...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const user = await db.transaction(async (client) => {
      ...
      await client.query<never>('SAVEPOINT sp_profiles')
      try {
        await client.query<never>(
