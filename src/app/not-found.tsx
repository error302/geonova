    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        <div className="mb-6 flex justify-center">
          <MetarduLogo size={48} showWordmark={true} color="var(--text-primary)" />
        </div>

        <div className="mb-6 inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-[var(--accent-subtle)] border border-[color-mix(in_srgb,var(--accent)_20%,transparent)]">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-3 justify-center">
          ...
          <Link href="/tools/all" className="btn btn-secondary">
            Browse Tools
          </Link>
